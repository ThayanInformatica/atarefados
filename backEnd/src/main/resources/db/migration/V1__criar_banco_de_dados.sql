...
INSERT INTO estado_tarefa(id_estado_tarefa, pendente, concluida, denuncia, nao_feita)
...
INSERT INTO estado_tarefa(id_estado_tarefa, pendente, concluida, denuncia, nao_feita)
VALUES (3, true, false, false, false);

INSERT INTO tarefas(id_tarefa, nome_tarefa, desricao, data, id_usuario, id_estado_tarefa)
VALUES (1, 'Larva Louça', 'Lavar as louças da pia e as panelas', '2020-03-04', 1, 1);

INSERT INTO tarefas(id_tarefa, nome_tarefa, desricao, data, id_usuario, id_estado_tarefa)
VALUES (2, 'Limpar a casa', 'Limpar a casa para passar o pano', '2020-03-04', 1, 2);

INSERT INTO tarefas(id_tarefa, nome_tarefa, desricao, data, id_usuario, id_estado_tarefa)
VALUES (3, 'lavar o banheiro', 'Lavar o banheiro e esfregar as paredes', '2020-03-04', 1, 3);
