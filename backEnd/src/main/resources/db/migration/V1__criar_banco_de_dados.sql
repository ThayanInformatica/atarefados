...
VALUES (1, 'Larva Louça', 'Lavar as louças da pia e as panelas', '2020-02-02', 1);

INSERT INTO tarefas(id_tarefa, nome_tarefa, desricao, data, id_usuario)
VALUES (2, 'Limpar a casa', 'Limpar a casa para passar o pano', '2020-02-02', 1);

INSERT INTO tarefas(id_tarefa, nome_tarefa, desricao, data, id_usuario)
VALUES (3, 'lavar o banheiro', 'Lavar o banheiro e esfregar as paredes', '2020-02-02', 1);
...
INSERT INTO estado_tarefa(id_estado_tarefa, pendente, concluida, denuncia, nao_feita, id_tarefa)
VALUES (1, true, false, false, nao_feita, 1);
