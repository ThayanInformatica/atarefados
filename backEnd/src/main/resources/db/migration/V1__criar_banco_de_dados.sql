...
VALUES (1, 'Larva Louça', 'Lavar as louças da pia e as panelas', '2020-07-03', 1, 1);

INSERT INTO tarefas(id_tarefa, nome_tarefa, desricao, data, id_usuario, id_estado_tarefa)
VALUES (2, 'Limpar a casa', 'Limpar a casa para passar o pano', '2020-07-03', 1, 2);

INSERT INTO tarefas(id_tarefa, nome_tarefa, desricao, data, id_usuario, id_estado_tarefa)
VALUES (3, 'lavar o banheiro', 'Lavar o banheiro e esfregar as paredes', '2020-07-03', 1, 3);
